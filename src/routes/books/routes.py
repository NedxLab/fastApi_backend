...
from src.models.books.models import Book, BookCreate, BookResponse,BookUpdate
...
@book_router.get("/", status_code=status.HTTP_201_CREATED, response_model=list[BookResponse])
